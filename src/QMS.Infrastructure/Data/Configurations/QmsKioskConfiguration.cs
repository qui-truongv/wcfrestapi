...
public class QmsKioskConfiguration : IEntityTypeConfiguration<QMS_KIOSK>
{
    public void Configure(EntityTypeBuilder<QMS_KIOSK> builder)
    {
        builder.ToTable("QMS_KIOSK");
